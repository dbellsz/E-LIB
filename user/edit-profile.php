...
$stmt = $con->prepare("Update admin set password=:hashedpwd, salt=:salt where username=:usernameForDb");
...
$sql = "select * from admin  where username=:username and active = :active";
